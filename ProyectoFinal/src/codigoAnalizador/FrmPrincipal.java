...
public class FrmPrincipal extends javax.swing.JFrame {
        ...
        while (true) {
            ...
            switch (token) {
                ...
                case Diagonal_invertida:
                    resultado += "  <Diagonal invertida>\t" + lexer.lexeme + "\n";
                    break;
                ...
                case Signo_interrogacion:
                    resultado += "  <Signo interrogacion cierre>\t" + lexer.lexeme + "\n";
                    break;

                case Exponente:
                    resultado += "  <Operador exponete>\t" + lexer.lexeme + "\n";
                    break;
                ...
                case Op_incremento:
                    resultado += "  <Operador incremental>\t" + lexer.lexeme + "\n";
                    break;

                case Op_relacional_cadena:
                    resultado += "  <Operador relacional para cadenas>\t" + lexer.lexeme + "\n";
                    break;
                ...
                case Signo_dolar:
                    resultado += "  <Signo de dolar>\t" + lexer.lexeme + "\n";
                    break;
    ...
    private void initComponents() {
        ...
        btnAnalizarSin1 = new javax.swing.JButton();
        ...
        jLabel1.setText("Ingrese aquí el código a analizar");

        jLabel2.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel2.setText("Resultado del análisis");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Analizador Sintactico", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N

        txtAnalizarSin1.setEditable(false);
        txtAnalizarSin1.setColumns(20);
        txtAnalizarSin1.setRows(5);
        jScrollPane4.setViewportView(txtAnalizarSin1);

        btnAnalizarSin1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btnAnalizarSin1.setText("Analizar");
        btnAnalizarSin1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAnalizarSin1ActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addContainerGap())
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(btnAnalizarSin1)
                        .addGap(18, 18, 18)
                        .addComponent(btnLimpiarSin1)
    ...
    private void btnAnalizarSin1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarSin1ActionPerformed
        // TODO add your handling code here:
        String ST = txtResultado.getText();
        Sintax s = new Sintax(new codigoAnalizador.LexerCup(new StringReader(ST)));

        try {
            s.parse();
            txtAnalizarSin1.setText("Analisis realizado correctamente");
            txtAnalizarSin1.setForeground(new Color(25, 111, 61));
        } catch (Exception ex) {
            Symbol sym = s.getS();
            txtAnalizarSin1.setText("Error de sintaxis. Linea: " + (sym.right + 1) + " Columna: " + (sym.left + 1) + ", Texto: \"" + sym.value + "\"");
            txtAnalizarSin1.setForeground(Color.red);
        }
    }//GEN-LAST:event_btnAnalizarSin1ActionPerformed

    private void btnLimpiarSin1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarSin1ActionPerformed
        // TODO add your handling code here:
        txtAnalizarSin1.setText(null);
    ...
    private javax.swing.JButton btnAnalizarSin1;
